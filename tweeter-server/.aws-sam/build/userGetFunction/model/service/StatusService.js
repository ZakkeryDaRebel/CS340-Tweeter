...
class StatusService {
    // Helper Methods
    async getStatuses(lastItem, pageSize) {
        let [statuses, hasMore] = tweeter_shared_1.FakeData.instance.getPageOfStatuses(tweeter_shared_1.Status.fromDto(lastItem), pageSize);
